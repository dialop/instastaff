...
const RewardsBadges = () => {
  ...
  const badges = [
    ...
    { src: loveBadge, alt: "Love Badge", label: "Earned: become an Emergency Hero.", earned: true },
    { src: teamworkBadge, alt: "Teamwork Badge", label: "Challenge: Receive positive feedback.", earned: false },
