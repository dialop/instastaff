    ...
    <>
      <section className="w-full flex justify-center bg-blue-100">
        <div className="w-full flex container bg-blue-100 px-24">
          <div className="w-full flex flex-wrap justify-between bg-blue-100">
            <div className="z-10 w-[600px] mr-8 m-4 bg-white p-8 rounded-lg md:mr-8 shadow-lg">
            ...
            <div className="z-10 w-[600px] m-4 bg-white p-8 rounded-lg shadow-lg">
              <h2 className="mb-4 text-2xl text-center md:text-4xl text-black font-heading font-semibold">
