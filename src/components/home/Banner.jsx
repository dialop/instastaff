      ...
      <section className="w-full flex justify-center bg-blue-100">
        <div className="w-full flex container bg-blue-100 px-24">
          <div className="w-full flex flex-wrap justify-between bg-blue-100 md:justify-center">
            <div className="w-[100%] transform hover:-translate-x-12 transition ease-in-out duration-1000 z-10 w-[600px] mr-8 m-4 bg-white p-8 rounded-lg md:mr-8 shadow-lg">
            ...
            <div className="w-[100%] transform hover:translate-x-14 transition ease-in-out duration-1000 z-10 w-[600px] m-4 bg-white p-8 rounded-lg shadow-lg">
              <h2 className="mb-4 text-2xl text-center md:text-4xl text-black font-heading font-semibold">
